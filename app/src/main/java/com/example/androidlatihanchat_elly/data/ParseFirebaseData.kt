...
import com.example.androidlatihanchat_elly.model.Friend
...
import com.example.androidlatihanchat_elly.utilities.Const.Companion.NODE_IS_READ
...
import com.example.androidlatihanchat_elly.utilities.Const.Companion.NODE_RECEIVER_ID
import com.example.androidlatihanchat_elly.utilities.Const.Companion.NODE_RECEIVER_NAME
import com.example.androidlatihanchat_elly.utilities.Const.Companion.NODE_RECEIVER_PHOTO
import com.example.androidlatihanchat_elly.utilities.Const.Companion.NODE_SENDER_ID
import com.example.androidlatihanchat_elly.utilities.Const.Companion.NODE_SENDER_NAME
import com.example.androidlatihanchat_elly.utilities.Const.Companion.NODE_SENDER_PHOTO
import com.example.androidlatihanchat_elly.utilities.Const.Companion.NODE_TEXT
import com.example.androidlatihanchat_elly.utilities.Const.Companion.NODE_TIMESTAMP
...
class ParseFirebaseData {
    ...
    fun getMessagesForSingleUser(dataSnapshot: DataSnapshot): List<ChatMessage> {
        ...
        for (data in dataSnapshot.children){
            ...
            //Node isRead Adeded later, my be null
            read =
                data.child(NODE_IS_READ).value == null || java.lang.Boolean.parseBoolean(data.child(NODE_IS_READ).value!!
                    .toString())
    ...
    fun getAllLastMessage(dataSnapshot: DataSnapshot) : ArrayList<ChatMessage> {
        ...
        for (wholeChatData in dataSnapshot.children) {
            ...
            for (data in wholeChatData.children) {
                ...
                receiverId = data.child(NODE_RECEIVER_ID).value!!.toString()
                receiverName = data.child(NODE_RECEIVER_NAME).value!!.toString()
                receiverPhoto = data.child(NODE_SENDER_PHOTO).value!!.toString()
                //node is readis added later, my be null
                read =
