...
import com.example.androidlatihanchat_elly.fragment.ChatsFragment
import com.example.androidlatihanchat_elly.services.NotificationService
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        when (id) {
            R.id.action_logout -> {
                val logoutIntent = Intent(this, SplashAct::class.java)
